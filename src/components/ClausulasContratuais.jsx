...
const ClausulasContratuais = () => {
  return (
    <div className="clausulas-contratuais">
      <h3 className="clausulas-titulo">CLÁUSULAS CONTRATUAIS</h3>

      <div className="clausulas-lista">
        <p>
...
export default ClausulasContratuais;
