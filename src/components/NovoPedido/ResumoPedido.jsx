...
const ResumoPedido = ({
  ...
  const pedidoData = {
    ...
    concessionariaNome: concessionariaCompradora?.nome || concessionariaInfo?.nome || '',
    concessionariaCnpj: concessionariaCompradora?.cnpj || concessionariaInfo?.cnpj || '',
    concessionariaEndereco: concessionariaCompradora?.endereco || concessionariaInfo?.endereco || '',
    concessionariaTelefone: concessionariaCompradora?.telefone || concessionariaInfo?.telefone || '',
    concessionariaEmail: concessionariaCompradora?.email || concessionariaInfo?.email || '',
