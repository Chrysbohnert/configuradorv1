...
const AdminNavigation = ({ user }) => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      label: 'Nova Proposta de Acessórios',
      visible: fullAccess,
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  const groups = [
    { id: 'dashboard', direct: true, item: findItem('/dashboard-admin') },
    {
      ...
      items: [
        ...
        findItem('/admin/nova-proposta-acessorio'),
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/gerenciar-acessorios', label: 'Acessórios', visible: fullAccess, icon: <Package size={20} /> },
