...
router.get('/pendentes', requireAuth, requireRole('admin_full', 'admin_representantes', 'admin_canal_interno'), asyncHandler(async (req, res) => {
...
router.put('/:id/aprovar', requireAuth, requireRole('admin_full', 'admin_representantes', 'admin_canal_interno'), asyncHandler(async (req, res) => {
...
router.put('/:id/negar', requireAuth, requireRole('admin_full', 'admin_representantes', 'admin_canal_interno'), asyncHandler(async (req, res) => {
