...
router.post('/simular', requireAuth, requireAdmin, asyncHandler(async (req, res) => {
...
router.post('/simular-salvar', requireAuth, requireAdmin, asyncHandler(async (req, res) => {
...
router.get('/historico', requireAuth, requireAdmin, asyncHandler(async (req, res) => {
...
router.get('/historico/:id', requireAuth, requireAdmin, asyncHandler(async (req, res) => {
...
router.delete('/historico/:id', requireAuth, requireAdmin, asyncHandler(async (req, res) => {
