...
router.post('/importar', requireAuth, requireAdminFull, upload.single('arquivo'), asyncHandler(async (req, res) => {
...
router.get('/atual', requireAuth, requireAdminFull, asyncHandler(async (_req, res) => {
